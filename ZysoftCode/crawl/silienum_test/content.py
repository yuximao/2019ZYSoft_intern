...
fa = open("G:\医疗文章\小桔灯\以“医疗”为关键字\医疗文章\医疗文章集链接.txt", 'r', encoding='utf-8')
lines = fa.readlines()
fb = open("G:\医疗文章\小桔灯\以“医疗”为关键字\医疗文章\医疗文章.csv", 'a+', encoding='utf-8')
...
fb = open("G:\医疗文章\小桔灯\以“医疗”为关键字\医疗文章\医疗文章.csv", 'a+', encoding='utf-8')
dataframe = pd.DataFrame({'文章标题':titlearr, '日期':datearr, '编辑人员':editarr, '查看次数':checkcountarr, '评论次数':commentcountarr, '来源':sourcearr, '文章内容':articlearr})
dataframe.to_csv("G:\医疗文章\小桔灯\以“医疗”为关键字\医疗文章\医疗文章.csv", index=False, encoding='utf_8_sig')
